...
class RocketDetails: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let rocketDetailsStr = self.rocketDetails
        cell.rocketLncDt.text = detailsStr + rocketDetailsStr
        ...
        AF.request(urlStr).responseJSON { response in
            ...
            if let value = response.value {
                ...
                if  (dict["details"] != nil) {
                    ...
                    self.rocketDetails = (dict["details"] as? NSString ?? String() as NSString) as String
